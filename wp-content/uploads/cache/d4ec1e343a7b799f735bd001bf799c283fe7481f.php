<?php $__env->startSection('content'); ?>
  ...
  <div class="membership-pricing bg-membership-color mt-0 pt-0 xl:pt-86 pb-86 flex justify-around content-center text-center align-center items-center">
    ...
    <?php $__currentLoopData = $get_membership_pricings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $get_membership_pricing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php if($loop->iteration%2 === 0): ?> 
          <div class="w-full md:w-1/2 lg:w-auto md:float-right">
            <div class="pricing-item bg-white text-center items-center">
              <div class="title">
                <p  class="text-secondary"><?php echo $get_membership_pricing['title']; ?></p>
              </div>
              <div class="price-tag">
                <h2  class="text-secondary">£<?php echo $get_membership_pricing['price']; ?></h2>
              </div>
              <div class="price-desc">
                <p class="text-secondary text-left">
                    <?php echo $get_membership_pricing['description']; ?>   
                </p>
              </div>
              <div class="price-button">
                <a class="btn bg-custom-bg text-secondary" href="<?php echo $get_membership_pricing['page_link']; ?>">Find Out More</a>
              </div>
            </div>
          </div>
        <?php else: ?> 
          <div class="w-full md:w-1/2 lg:w-auto md:float-right">
            <div class="pricing-item bg-primary text-center items-center">
              <div class="title">
                <p  class="text-white"><?php echo $get_membership_pricing['title']; ?></p>
              </div>
              <div class="price-tag">
                <h2  class="text-white">£<?php echo $get_membership_pricing['price']; ?></h2>
              </div>
              <div class="price-desc">
