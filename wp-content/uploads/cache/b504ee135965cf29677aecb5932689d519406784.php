    ...
    <div class="container events-container">
        ...
        <div class="events-content">
            ...
            <div class="latest-news">
                  ...
                  <div class="latest-news-featured">
                        <div class="latest-news-featured-bg" style="height: 100%;">
                            <div class="w-full flex flex-row flex-wrap lg:flex-no-wrap min-h-blog-height" style="height: 100%;">
                                <div class="featured-image-bg w-full lg:w-2/3" style="background-image: url('<?php echo e(get_the_post_thumbnail_url()); ?>')" onclick="document.location.href='<?php echo e(get_permalink()); ?>'">
                                </div>
                                <div class="w-full lg:w-1/3 feat_blog_details flex">
                                    <div class="text-content-bg flex flex-col">
                                        <div class="date">
                                            <p><?php echo e(the_time('d/n/Y')); ?></p>
                                        </div>
                                        <div class="title">
                                            <a href="<?php echo e(get_permalink()); ?>"><h2><?php echo App\limit_character(get_the_title(), '45'); ?></h2></a>
                                        </div>
                                        <div class="content">
                                            <p><?php the_excerpt() ?></p>
                                        </div>
                                        <div class="secondary-button-bg mt-13 w-193.42 h-54 w-full">
                                            <div class="button">
                                              <a href="<?php echo e(get_permalink()); ?>" class="text-secondary flex justify-center items-center align-center">read more
                                              </a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <?php } else  { ?>
                        <div class="item xl:w-blogitemswidth md:w-1/2 size1200:w-full w-full mr-0 pr-0 lg:pr-60 xl:pr-0 mr-0 pb-10" <?php if ($postCount % 4 == 0) echo "style='margin-right: 0;'" ?>>
                          <div class="news-cotent-bg flex-wrap <?php if ($postCount == $numberPosts) echo 'last-item'; ?>">
                            <div class="news-content-featured-bg" style="background-image: url('<?php echo e(get_the_post_thumbnail_url()); ?>')" onclick="document.location.href='<?php echo e(get_permalink()); ?>'">
                            ...
                            <div class="news-content-info">
                              <div class="news-content-title">
                                <a href="<?php echo e(get_permalink()); ?>"><?php echo App\limit_character(get_the_title(), '50'); ?></a>
                              </div>
                              <div class="news-content-summary">
                                <p><?php echo App\limit_character(get_the_excerpt(), '260'); ?></p>
                              </div>
                              <div class="news-read-more flex inline">
                                <p><a href="<?php echo e(get_permalink()); ?>" class="read-more-link">Read more  
                                ...
                                <p class="date"><span><?php echo e(the_time('d/n/Y')); ?></span></p>
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              <?php echo App\pagination($wp_query->max_num_pages, 'news'); ?>
