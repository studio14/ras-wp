...
<footer class="content-info">
  <div class="partners">
    <div class="container xxl:pl-container xxl:pr-container my-partners-container">
      <div class="flex inline partners-bg flex-col xl:flex-row mr-63 pt-12 xl:pt-0 pb-12 xl:pb-0">
        <?php $__currentLoopData = $get_clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="item-2">
          ...
          <div class="w-full xl:w-19-5p float-left">
            <div class="content mt-78">
              ...
              <div class="bottom-fotter-link--bg mt-29">
                  <?php if(has_nav_menu('footer_widget_navigation')): ?>
                    <?php echo wp_nav_menu(['theme_location' => 'footer_widget_navigation', 'menu_class' => 'bottom-fotter-link']); ?>
  ...
  <?php echo $__env->make('partials.bottom-footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <!-- The Modal -->
