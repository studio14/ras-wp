          ...
          <div class="summary our-team-bg">
            <div class="w-full">
                <div class="our-team flex inline flex-wrap justify-between">
                    <?php $__currentLoopData = $get_peoples; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $get_people): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
