...
<div class="slideshow-container">
  ...
  <?php $__currentLoopData = $custom_sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $custom_slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <div class="home-page" style="background-image: url(<?php echo $custom_slider['featured_image']; ?>);">
    <div class="home-title-bg">
      <div class="home-title-bg--text container">
        <div class="home-title-bg--text--bg">
          <div class="container">
            <div class=" text-title-tittle">
              <h2><?php echo $custom_slider['title']; ?></h2>
              <div class="action-button-bg">
                <a href="<?php echo $custom_slider['slider']['home_button_link']; ?>" class="btn primary-button"><?php echo $custom_slider['slider']['home_button_text']; ?> 
              ...
              <div class="events-cotent-bg">
                <div class="content">
                  ...
                  <div class="content-main">
                   ...
                   <p><?php echo App\limit_character(get_the_excerpt(), '180'); ?></p>
                  </div>
