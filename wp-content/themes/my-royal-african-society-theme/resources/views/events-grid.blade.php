                      ...
                      <div class="events-show grid">
                          <div class="events-show-grid">
                              ...
                              if (have_posts()) :
                                  ...
                                  $args = array('post_type' => 'events', 
                                      ...
                                      'meta_query' => array(
                                          array(
                                              ...
                                              'orderby' => 'meta_value',
                                              'order'	    => 'DESC',
                                              'value' => $_GET['date'] ? date('Y-m-1', $_GET['date']) : date('2013-01-1'),
                                              'compare' => '>=',
                                              'type' => 'DATE'
                                          ),
                                          array(
                                  ...
                                  $events_link = get_post_meta($wp_query->post->ID, 'events_link');
                                  $events_location = get_post_meta($wp_query->post->ID, 'events_location');
                                  $events_ticket_price = get_post_meta($wp_query->post->ID, 'events_ticket_price');
                                  $events_starting_time = get_post_meta($wp_query->post->ID, 'events_starting_time');
                                  $events_ending_time = get_post_meta($wp_query->post->ID, 'events_ending_time');
                                  $members_only = get_post_meta($wp_query->post->ID, 'members_only');
                                  $events_permalink = get_the_permalink($wp_query->post->ID);
                                  $terms = wp_get_post_terms( $wp_query->post->ID, 'events_category' );
                                  $eventtitle = get_post_field( 'post_title', $wp_query->post->ID, 'raw' );
                                  $category = $terms[0]->name;
                                  $featuredImageUrl = get_the_post_thumbnail_url($wp_query->post->ID);
                                                      ...
                                                      <div class="events-title-header-bg mt-5 xl:mt-16">
                                                          <div class="events-title-header">
                                                              <a href="<?= $events_permalink; ?>">
                                                                  <h2 class="text-white">
                                                                      {!! App\limit_character($eventtitle, '60') !!}
                                                                  </h2>
                                                              </a>
                                                              <div class="events-description  custom-header-size max-w-419.97 hidden md:block">
                                                                    <p class="text-white">{!! App\limit_character(get_the_excerpt(), '150') !!}</p>
                                                                </div>
                                                          </div>
                                                      ...
                                                      <div class="events-single-header-bg w-full">
                                                          ...
                                                          <div class="events-title-header-bg mt-5">
                                                              <div class="events-title-header cutom-event-size-2">
                                                                  <a href="<?= $events_permalink; ?>">
                                                                      <h2 class="text-white">
                                                                          {!! App\limit_character($eventtitle, '35') !!}
                                                                      </h2>
                                                                  </a>
                                                              </div>
                          ...
                          {!! App\e_pagination($wp_query->max_num_pages, 'events') !!} 
                          <?php $wp_query = null;
                              $wp_query = $temp;
                              wp_reset_postdata();
                          endif;
