			...
			foreach($group_id_arr as $groupId) {
				...
				if ( ! empty( $get_acf_flexible_content_fields ) ) {
					foreach ( $get_acf_flexible_content_fields as $acf_pro_fc_fields ) {
						...
						$customFields["ACF"][ $acf_pro_fc_fields->post_excerpt ]['label'] = $acf_pro_fc_fields->post_title;
						$customFields["ACF"][ $acf_pro_fc_fields->post_excerpt ]['name']  = $acf_pro_fc_fields->post_excerpt;
					}
