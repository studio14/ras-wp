...
class FileManager {
    ...
    public function downloadAllFiles(){
		...
		//$recordDetails = $wpdb->get_results($wpdb->prepare("select * from ultimate_cfimporter_pro_smackuci_events where id = %d",$id));
    ...
    public function deleteFiles()
	{
		...
		//$filekey = $wpdb->get_col($wpdb->prepare("select eventKey,id from ultimate_cfimporter_pro_smackuci_events where revision=%d and original_file_name=%s", $version,$filename));
